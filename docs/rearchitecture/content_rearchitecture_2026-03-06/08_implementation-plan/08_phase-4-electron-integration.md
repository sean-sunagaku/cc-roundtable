...
- [ ] Electron アプリを実際に起動し、会議開始が daemon 経由で動くことを確認する
- [ ] Meeting 画面から入力送信し、event 購読で UI が更新されることを確認する
- [ ] Electron を再起動して既存 session へ reconnect できることを確認する
- [ ] Debug / Terminal 系表示が daemon 提供データで成立することを確認する
