...
- [ ] meeting 開始から終了までの重要イベントが実際に append-only で残ることを確認する
- [ ] 保存済み event log から projection を再構築して期待どおりの session view になることを確認する
- [ ] daemon 再起動後に projection を再読込して session 状態を復元できることを確認する
- [ ] summary / health projection が event に追随して更新されることを確認する
