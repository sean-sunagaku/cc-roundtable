...
- レビュー結果は `TODO.md` の review log に残す。
- 実装中に不足タスクが見つかったら、この plan と `TODO.md` の両方へ追記する。

## Current Focus
- W2-W4: backend parity / Web shell / build-serve / Web E2E まで実装済み
- W5.1: `npm --prefix electron run e2e:web` と `npm --prefix electron run verify:final` は成功
